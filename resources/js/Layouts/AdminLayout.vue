            ...
            <aside id="application-sidebar-brand"
                ...
                <div class="p-5">
                    <a href="../" class="text-nowrap">
                        <img src="assets/admin/assets/images/logos/dark-logo.svg" alt="Logo-Dark" />
                    </a>
                </div>
                ...
                <div class="m-6 relative">
                    <div class="bg-blue-500 p-5 rounded-md flex items-center justify-between">
                        ...
                        <div class="-mt-12 -mr-2">
                            <img src="assets/admin/assets/images/profile/rocket.png" class="max-w-fit" alt="profile" />
                        </div>
                    </div>
                </div>
            </aside>
                            ...
                            <div
                                ...
                                <a class="relative hs-dropdown-toggle cursor-pointer align-middle rounded-full">
                                    <img class="object-cover w-9 h-9 rounded-full"
                                        src="assets/admin/assets/images/profile/user-1.jpg" alt="" aria-hidden="true">
                                </a>
